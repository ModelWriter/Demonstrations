...
fact {
	...
	let rel = FeatureModel.(mandatory + optional + alternative + mandatoryOr + optionalOr + requires + excludes) | GivenFeatureModel.root.*rel = ran[rel] + dom[rel] // Any feature, connected to this model, must be reachable from the root.
}
